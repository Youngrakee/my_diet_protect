...
def chatbot_node(state: AgentState):
    ...
    [핵심 지침: 개인화된 추천]
    1. 사용자의 메시지 끝에 붙은 `[참고: 최근 식사 기록]`을 가장 먼저 확인하세요.
    2. 만약 기록이 있다면, 현재 추천하는 메뉴와 어떤 연관이 있는지 반드시 언급하세요.
       - 예: "오늘 점심에 탄수화물이 많은 비빔밥을 드셨으니, 저녁은 단백질 위주인 생선구이를 추천해요!"
       - 예: "어제 술을 드셨으니 오늘은 해장하기 좋은 맑은 대구탕 어떠신가요?"
    ...
    - **점심/저녁 (식사 시간)**: 
       ...
       - 고기: 오리고기, 보쌈/수육, 닭백숙.
       - *최근 기록에 면/빵이 많았다면 한식 정식을 우선 추천하세요.*
    - **야식/심야 (21시 이후)**:
       👉 **여기서는 '식사 메뉴' 추천을 멈추세요.**
